...
/**
 * recursion_bst - check if each node has in the left a less value that himself
 * @root: node to check
 * @min_left: min value to check with the node at the left
 * @max_right: max value to check with the node at the right
 * Return: 1 if is a BTS or 0 otherwise
 */
 ...
 * Return: 1 if the tree is a nid BST, and 0 otherwise
